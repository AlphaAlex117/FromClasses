...
public abstract class AbstractSorter
{
	...
	// True if set comparator has been called.
	protected boolean isComparatorSet = false;
	...
	public void setComparator(int order) throws IllegalArgumentException
	{
		...
		{
			System.out.println("0 to compare by x-coordinates or 1 to compare by y-coordinates.");
		}
	}
